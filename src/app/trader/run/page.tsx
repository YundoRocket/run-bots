...
export default function TraderRunPage() {
  return (
    <div className="container mx-auto px-4 py-12 max-w-4xl">
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">How to Run a Trader Bot</h1>
      ...
      <Alert className="mb-8 border-yellow-900 bg-yellow-900/20">
        ...
        <AlertDescription>
          <ul className="list-disc list-inside mt-2 space-y-1">
            <li>trader-ppss.yaml file downloaded from the creation page</li>
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <pre className="bg-muted p-3 rounded-md text-sm overflow-x-auto">
                <code>{`mkdir trader-run && cd trader-run`}</code>
              </pre>
            </div>

            <div>
              <h3 className="font-semibold mb-2">2. Place your trader-ppss.yaml file</h3>
  ...
  pdr trader /work/trader-ppss.yaml testnet`}</code>
              </pre>
            </div>
...
source venv/bin/activate  # On Windows: venv\\Scripts\\activate`}</code>
            ...
            <div>
              ...
              <pre className="bg-muted p-3 rounded-md text-sm overflow-x-auto">
                <code>{`pdr trader trader-ppss.yaml testnet`}</code>
              </pre>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-3">
            <div>
              ...
              <pre className="bg-muted p-3 rounded-md text-sm">
                <code>{`docker compose logs -f trader`}</code>
              </pre>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                ...
                <li>
                  <strong>Strategy error</strong>: Check that the strategy is supported
                </li>
                <li>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
              <li>Logs to detect errors</li>
              <li>Output files (executed trades, performance)</li>
              <li>Wallet balance (gas consumed, profits/losses)</li>
              <li>Strategy metrics (win rate, drawdown, etc.)</li>
            </ul>
            <Alert className="mt-4 border-orange-900 bg-orange-900/20">
              <AlertTitle>💡 Tip</AlertTitle>
              <AlertDescription>
                Always start with a low stake and increase gradually after validating
                the strategy over several days/weeks.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
            ...
            <Alert className="border-orange-900 bg-orange-900/20">
              ...
              <AlertDescription>
                ...
                <ul className="list-disc list-inside space-y-1">
                  <li>Test your bot thoroughly on testnet for several days</li>
                  <li>Analyze real performance (win rate, drawdown, Sharpe ratio)</li>
                  <li>Check your funds and gas fees on mainnet</li>
                  <li>Start with a low stake</li>
                  <li>Monitor 24/7 for the first 48 hours</li>
                  <li>Set up alerts (low balance, repeated errors)</li>
                </ul>
              </AlertDescription>
            </Alert>
            <p className="text-sm text-muted-foreground mt-4">
              To switch to mainnet, recreate your trader-ppss.yaml with network: mainnet, and run with
